(function (factory) {
    ...
    var specsMap = {};
    var buildingTitle = "Kr_Test";
    var beforeAllLabel = "__Kr_Test__beforeAll";
    var afterAllLabel = "__Kr_Test__afterAll";
    ...
    function runTests() {
        ...
        return new Promise(function (res, rej) { return __awaiter(_this, void 0, void 0, function () {
            var passCount, specKey, itKey, successResult, failResult, printPassMsg, _a, _b, _c, _i, _d, _e, _f, _g, err_1;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        ...
                        failResult = function (err) {
                            return {
                                success: false,
                                passCount: passCount,
                                errMsg: "[".concat(specKey, "|").concat(itKey, "] failed. reason: ").concat(err.message)
                            };
                        };
                    ...
                    case 2:
                        ...
                        specKey = _c;
                        if (!specsMap[specKey][beforeAllLabel]) return [3 /*break*/, 4];
                        return [4 /*yield*/, specsMap[specKey][beforeAllLabel]()];
                    case 3:
                        _h.sent();
                        _h.label = 4;
                    case 4:
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, specsMap[specKey][itKey]()];
                    case 6:
                        _h.sent();
                        passCount++;
                        printPassMsg();
                    ...
                    case 7:
                        ...
                        return [3 /*break*/, 5];
                    case 8:
                        if (!specsMap[specKey][afterAllLabel]) return [3 /*break*/, 10];
                        return [4 /*yield*/, specsMap[specKey][afterAllLabel]()];
                    case 9:
                        _h.sent();
                        _h.label = 10;
                    case 10:
    ...
    var WorkerFactory = createBase64WorkerFactory('', null, false);
    /* eslint-enable */
    ...
    var require_context_module_0_0 = spec("QuickWebAssemblyFactory test", function() {
        ...
        it("basic use", async done => {
            chai_1(await fibManager.fib(12)).eq(233);
            ...
            chai_1(heap instanceof Float32Array).true;
            chai_1(heap.length).eq(10);
            console.log(heap);
            done();
        });
    });
    ...
    (function (global, factory) {
        ...
        var QuickWebAssemblyFactory =  (function () {
            function QuickWebAssemblyFactory() {
            }
                                    ...
                                    createHEAP: function (data) { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    msg = { cmd: "createHeap", args: [new Int8Array(data)] };
                                                    return [4 , promiseWorker$1.postMessage(msg)];
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    msg = { cmd: "getHeap", args: [ptr, bytes] };
                                                    return [4 , promiseWorker$1.postMessage(msg)];
                                                case 1: return [2 , (_a.sent()).buffer];
                                            }
                                        });
                                    }); },
                                    getHEAP8: function (ptr, len) { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    ...
                                                    _a = Int16Array.bind;
                                                    return [4 , promiseWorker$1.postMessage(msg)];
                                                case 1: return [2 , new (_a.apply(Int16Array, [void 0, (_b.sent()).buffer]))()];
                                            }
                                        });
                                    }); },
                                    getHEAP32: function (ptr, len) { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    ...
                                                    _a = Int32Array.bind;
                                                    return [4 , promiseWorker$1.postMessage(msg)];
                                                case 1: return [2 , new (_a.apply(Int32Array, [void 0, (_b.sent()).buffer]))()];
                                            }
                                        });
                                    }); },
                                    getHEAPF32: function (ptr, len) { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    ...
                                                    _a = Float32Array.bind;
                                                    return [4 , promiseWorker$1.postMessage(msg)];
                                                case 1: return [2 , new (_a.apply(Float32Array, [void 0, (_b.sent()).buffer]))()];
                                            }
                                        });
                                    }); },
                                    getHEAPF64: function (ptr, len) { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    ...
                                                    _a = Float64Array.bind;
                                                    return [4 , promiseWorker$1.postMessage(msg)];
                                                case 1: return [2 , new (_a.apply(Float64Array, [void 0, (_b.sent()).buffer]))()];
                                            }
                                        });
                                    }); },
                                    getHEAPU8: function (ptr, len) { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    ...
                                                    _a = Uint8Array.bind;
                                                    return [4 , promiseWorker$1.postMessage(msg)];
                                                case 1: return [2 , new (_a.apply(Uint8Array, [void 0, (_b.sent()).buffer]))()];
                                            }
                                        });
                                    }); },
                                    getHEAPU16: function (ptr, len) { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    ...
                                                    _a = Uint16Array.bind;
                                                    return [4 , promiseWorker$1.postMessage(msg)];
                                                case 1: return [2 , new (_a.apply(Uint16Array, [void 0, (_b.sent()).buffer]))()];
                                            }
                                        });
                                    }); },
                                    getHEAPU32: function (ptr, len) { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    ...
                                                    _a = Uint32Array.bind;
                                                    return [4 , promiseWorker$1.postMessage(msg)];
                                                case 1: return [2 , new (_a.apply(Uint32Array, [void 0, (_b.sent()).buffer]))()];
                                            }
                                        });
                                    }); },
                                };
    ...
    var require_context_module_0_3 = spec("test-class", function() {
      ...
      it("class constructor", done => {
        chai_1(testObj._name === "123").ok;
        done();
      });
      it("setName", done => {
        testObj.setName("krits");
        chai_1(testObj._name === "krits").ok;
        done();
      });
    ...
    */
    ...
    var TEST_CONFIG = {
        assetsPath: "assets/cpp/build.em"
    };
    ...
    window.onload = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, config$1()];
                case 1:
                    _a.sent();
